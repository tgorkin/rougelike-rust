...
const MAP_MAX_IDX: usize = MAP_WIDTH as usize * MAP_HEIGHT as usize;
...
impl Map {
    ...
    pub fn new_map_test() -> Map {
        let mut map = Map {
            tiles: vec![TileType::Floor; MAP_WIDTH as usize * MAP_HEIGHT as usize],
            rooms: Vec::new(),
            width: MAP_WIDTH,
            height: MAP_HEIGHT,
            revealed_tiles: vec![false; MAP_WIDTH as usize * MAP_HEIGHT as usize],
        ...
        for x in 0..map.width {
            ...
            let idx2 = map.xy_idx(x, map.height - 1);
        ...
        for y in 0..map.height {
            ...
            let idx2 = map.xy_idx(map.width - 1, y);
            map.tiles[idx1] = TileType::Wall;
            map.tiles[idx2] = TileType::Wall;
        }
